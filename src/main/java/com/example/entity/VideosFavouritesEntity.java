 ...
 */
@Entity
@Table(name = "video_favourites", schema = "dev",uniqueConstraints = @UniqueConstraint(columnNames = {"video_seq", "id"}))
public class VideosFavouritesEntity {
    ...
    public boolean equals(Object o) {
        ...
        VideosFavouritesEntity that = (VideosFavouritesEntity) o;
